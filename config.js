...
const APP_CONFIG = {
  ...
  ai: {
    ...
    storeHint:
      "Single-origin Arabica, artisan warm atmosphere. Regulars are coffee enthusiasts and young KL professionals.",
    quickChips: [
      {
        label: "🌙 Raya Theme",
        prompt: "Retheme for Hari Raya Aidilfitri — festive green and gold tones"
      },
      {
        label: "🎒 School Holidays",
        prompt: "Retheme for school holidays — brighter, more cheerful and welcoming"
      },
      {
  ...
  defaultMenu: {
    ...
    items: [
      ...
      // FRIDAY SPECIAL
      {
        id: "fr1",
        cat: "friday",
        name: "Chicken Buttermilk Basmati",
        desc: "Friday only",
        emoji: "🍛",
        hot: null,
        cold: null,
